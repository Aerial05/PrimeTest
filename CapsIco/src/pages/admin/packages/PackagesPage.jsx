        ...
        <div className={styles.card}>
            ...
            <div className={styles.headerActions}>
              ...
              {activeTab === 'single' ? (
                ...
                <button
                  ...
                  className={styles.btnPrimary}
                  onClick={() => {
                    // Save current bundle draft, then prep a fresh bundle form
                    setLastBundleForm(form);
                    setActiveTab('bundle');
                    setEditingId(null);
                    setEditingDbId(null);
          ...
          <div className={styles.cardBody}>
            <form onSubmit={handleSubmit}>
                ...
                <>
                  <div className={styles.formRow}>
                    ...
                    <div className={styles.formGroup}>
                      ...
                      <select id="singleIsActive" name="singleIsActive" value={form.singleIsActive} onChange={handleChange}>
                    ...
                    <div className={styles.formGroup}>
                      ...
                      <div className={styles.inlineControl}>
                        <input
                          ...
                          onChange={handleSingleUseRegularSchedule}
                        />
              ...
              {/* Single services additional info merged into Description above */}
              ...
              <div className={styles.formActions}>
                ...
                {activeTab === 'single' && (
                  <button type="button" className={styles.btnSecondary} onClick={handleAddService}>
                    Add Service
                  </button>
                )}
                {activeTab === 'bundle' && (
              ...
              <table className={styles.table}>
                ...
                <tbody>
                  {filteredServices.length === 0 ? (
                    <tr>
                      <td colSpan={activeTab === 'bundle' ? 5 : 4} className={styles.empty}>No items found.</td>
                    </tr>
                  ) : (
