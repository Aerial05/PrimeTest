...
const services = [
  {
    ...
    short: "Mon-Sat 7:00 AM - 4:00 PM; Sun 7:30 AM - 11:30 AM",
  ...
  { id: "drugtest", name: "Drug Testing", provider: "Prime Medical Laboratory", schedule: { days: [0,1,2,3,4,5,6], start: "07:00", end: "16:00" }, note: "Daily 7:00 AM - 4:00 PM.", short: "Daily 7:00 AM - 4:00 PM", price: "PHP 280" },
  { id: "animalBite", name: "Animal Bite Center", provider: "Prime Medical Laboratory", schedule: { days: [1,3,4,6], start: "08:00", end: "16:00" }, note: "Mon, Wed, Thu, Sat 8:00 AM - 4:00 PM. Free anti-rabies vaccine is walk-in and first-come, first-served.", short: "Mon/Wed/Thu/Sat 8:00 AM - 4:00 PM", priceNote: "Total cost depends on vaccine doses, ERIG need and follow-ups." },
  { id: "freeRabies", name: "Free Anti-Rabies Vaccine", provider: "Prime Medical Laboratory", type: "per-appointment", note: "Walk-in only on Mon/Wed/Thu/Sat, 8:00 AM - 4:00 PM (last call 3:30 PM). First-come, first-served; first 30 patients.", short: "Walk-in Mon/Wed/Thu/Sat 8:00 AM - 4:00 PM", priceNote: "Vaccine is free on listed days for eligible patients; other meds/procedures may have costs." },
];
...
export function BookAppointment() {
  ...
  const mapItemToServiceId = (title = "") => {
    ...
    if (t.includes("konsulta") || t.includes("consult")) return "consultation";
    return null;
  };
  ...
  const selectFromCatalog = (title) => {
    const sid = mapItemToServiceId(title) || 'laboratory';
