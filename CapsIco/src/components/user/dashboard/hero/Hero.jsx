...
const TABS = [
  { name: 'Prime Medical Front', src: 'https://momento360.com/e/u/4614a6341be84cb4808f9634ca46f65e?utm_campaign=embed&utm_source=other&heading=0&pitch=0&field-of-view=75&size=medium&display-plan=true' },
  ...
  { name: 'Dr. Joy Check Up Room', src: 'https://momento360.com/e/u/24a2d6cb487f49e2b0bbebd6237f8c91?utm_campaign=embed&utm_source=other&heading=0&pitch=0&field-of-view=75&size=medium&autoplay-annotations=true&display-plan=true' },
  { name: 'Ultra Sound Room', src: 'https://momento360.com/e/u/c33dc449e344402bb4555f6a908b2ca2?utm_campaign=embed&utm_source=other&heading=0&pitch=0&field-of-view=75&size=medium&display-plan=true' },
  { name: 'Work Room Xray', src: 'https://momento360.com/e/u/fdeffb07ef184fa4a27f8e845cea301c?utm_campaign=embed&utm_source=other&heading=128&pitch=0.25&field-of-view=75&size=medium&display-plan=true '},
  { name: 'Xray Room', src: 'https://momento360.com/e/u/3e379cea55cf45cabefdd5ee79ef7348?utm_campaign=embed&utm_source=other&heading=0&pitch=0&field-of-view=75&size=medium&display-plan=true' },
...
const TAB_INFO = [
  {
    label: "WELCOME TO PRIME MEDICAL FRONT",
...
export function Hero() {
  const [activeTab, setActiveTab] = useState(3); // Default to Ultra Sound Room
